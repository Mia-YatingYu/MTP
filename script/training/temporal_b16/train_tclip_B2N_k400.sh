...
CUDA_VISIBLE_DEVICES=4,5,6,7 \
  ...
  --opts DATA.PATH_TO_DATA_DIR $ROOT/zs_label_db/B2N_k400_s3 \
  DATA.PATH_PREFIX /data3/yuyating/dataset/OpenMMLab___Kinetics-400/raw/videos_se256 \
  DATA.PATH_LABEL_SEPARATOR , \
  DATA.INDEX_LABEL_MAPPING_FILE $ROOT/zs_label_db/B2N_k400/raw_train_idx2cls.json \
  DATA.TEXT_AUG True \
  DATA.TEXT_AUG_FEATURE_FILE $CKPT/text_feats/classes_text_feats_k400_tpl8_xmix_ViT-B_16.pt \
  TRAIN.ENABLE True \
  OUTPUT_DIR $CKPT/STDD_ch32_ts1+2/vitb16_8x16/B2N_K400_s3 \
  TRAIN.BATCH_SIZE 32 \
  TEST.BATCH_SIZE 128 \
